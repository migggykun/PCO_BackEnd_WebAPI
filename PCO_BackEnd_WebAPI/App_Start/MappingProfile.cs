    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            Func<PRCDetail, ResponsePRCDetailDTO> convertToPRCDTO = (x) => x == null ? new ResponsePRCDetailDTO() { Id = string.Empty, IdNumber = string.Empty, ExpirationDate = string.Empty, RegistrationDate = string.Empty } :
                                                                             new ResponsePRCDetailDTO() { Id = x.Id.ToString(), IdNumber = x.IdNumber, ExpirationDate = x.ExpirationDate != null?x.ExpirationDate.Value.ToString("yyyy'-'MM'-'dd"):string.Empty, RegistrationDate = x.RegistrationDate != null? x.RegistrationDate.Value.ToString("yyyy'-'MM'-'dd"): string.Empty };
